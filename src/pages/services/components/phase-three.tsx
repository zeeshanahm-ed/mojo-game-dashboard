...
function PhaseThree({ phase, serviceData, refetchCaseData, caseDocumentData, collapseAll, collapseVersion }: any) {
  ...
  return (
    ...
    >
      ...
      <div className='mt-8'>
        <Checkbox className='text-base' checked={isStabilized} onChange={handleCheckbox}>Stabilized for phase 3</Checkbox>
      </div>
    </CollapsibleSection>
  );
}
